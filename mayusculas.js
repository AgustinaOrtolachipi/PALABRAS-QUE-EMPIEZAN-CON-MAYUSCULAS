"use strict";
// contar cuantas palabras empiezan con mayusculas  deberia devolver lo siguiente La cantidad de palabras que empiezan con mayúscula es:
...
var contador = 0;
function contarMayus(cadenaDeTexto) {
...
console.log("La cantidad de palabras que empiezan con mayusculas es : ".concat(contarMayus(cadenaDeTexto)));
